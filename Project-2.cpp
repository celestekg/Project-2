...
The program prompts the user to guess a value from 1-100,
and then tells the user if the value is too high or too low
until the user enters the correct value, and prints
the result.*/
